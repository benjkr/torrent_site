  ...
  return (
    <>
      ...
      <div className="sticky top-16 z-40 -mx-4 px-4 py-2">
        <div
          className={cn(
            "flex flex-col gap-2 rounded-[1.35rem] p-2 sm:flex-row sm:items-center",
            glassShell,
          )}
        >
            ...
            {LIBRARY_FILTERS.map((f) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-[0.6875rem] font-medium transition-colors cursor-pointer",
                    on
                      ? "bg-white text-black"
...
export function LibraryChrome({
  ...
  return <LibraryChromeCompact {...props} />;
}
